#pragma once
#ifndef GLOBJECTOBJ_H
#define GLOBJECTOBJ_H
// stl include
#include <iostream>
#include <fstream>
#include <sstream>
...
private:
     ...
     */
    bool load_obj(const char* filename, vector<glm::vec3> &vertices, vector<glm::vec3> &normals, vector<glm::vec2> &textures, vector<GLuint> &elements);
